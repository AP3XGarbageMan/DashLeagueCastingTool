...
public class Domination_Manager : MonoBehaviour
{
    ...
    [SerializeField] private TextMeshProUGUI[] teamTopPanelScore;
    [SerializeField] private TextMeshProUGUI[] teamSBMapScore;

    [SerializeField] private Toggle wwToggle;
    [SerializeField] private Toggle quarryToggle;

    [SerializeField] private GameObject wwMapParent;
    [SerializeField] private GameObject quarryMapParent;
    [SerializeField] private GameObject payloadCartLightsHolder;
    [SerializeField] private GameObject domTeamColorFlash;

    [SerializeField] private GameObject[] wwMapParts;
    [SerializeField] private GameObject[] quarryMapParts;

    [SerializeField] private Material m_concrete;
    ...
    void DominationUpdate(Root data)
    {
